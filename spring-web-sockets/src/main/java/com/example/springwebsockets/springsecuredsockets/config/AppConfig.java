...
@Configuration
@EnableWebMvc
@EnableJpaRepositories("com.example.springwebsockets.springsecuredsockets.repository")
@EntityScan("com.example.springwebsockets.springsecuredsockets")
@ComponentScan("com.example.springwebsockets")
